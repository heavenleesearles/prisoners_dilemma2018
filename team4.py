...
Betray first round. Compare all rounds to the previous round and 
assume opponent will use the opposite of what was previously played. If the previous round's result never has 
